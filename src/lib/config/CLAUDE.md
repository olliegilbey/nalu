...
- Document the *why* of each value inline — source (SM-2 spec, PRD), rationale, and anti-gaming implications. A reviewer tweaking a number should see the full context without opening other files.
