 ...
 * site (`streamToolChat` here; `ToolLoopAgent` definitions in
 * `src/lib/agents/`). Two jobs, both per step:
 ...
 *    probe verdict finding 1. Plain-string assistant messages pass through.
 */
